  ...
  static final GalleryData gallery = GalleryData(
    {
      ...
      'Ashish': [
        {'path': 'assets/Ashish/Ashish1.jpg', 'caption': 'The joy of family moments ❤️'},
        {'path': 'assets/Ashish/Ashish10.jpg', 'caption': 'Dream big, achieve bigger 🚀'},
        {'path': 'assets/Ashish/Ashish11.jpg', 'caption': 'A life full of adventures 🌍'},
        {'path': 'assets/Ashish/Ashish12.jpg', 'caption': 'A journey of growth 📈'},
        {'path': 'assets/Ashish/Ashish13.jpg', 'caption': 'Forever learning and growing 📚'},
        {'path': 'assets/Ashish/Ashish14.jpg', 'caption': 'Spreading positivity everywhere 🌸'},
        {'path': 'assets/Ashish/Ashish15.jpg', 'caption': 'The power of positivity ✨'},
        {'path': 'assets/Ashish/Ashish16.jpg', 'caption': 'Forever chasing dreams 🚀'},
        {'path': 'assets/Ashish/Ashish17.jpg', 'caption': 'Living with gratitude 🙏'},
        {'path': 'assets/Ashish/Ashish18.jpg', 'caption': 'A journey of self-discovery '},
        ...
        {'path': 'assets/Ashish/Ashish5.jpg', 'caption': 'A smile that inspires 😊'},
        {'path': 'assets/Ashish/Ashish6.jpg', 'caption': 'The joy of family moments ❤️'},
        {'path': 'assets/Ashish/Ashish7.jpg', 'caption': 'A life filled with love ❤️'},
        {'path': 'assets/Ashish/Ashish8.jpg', 'caption': 'Forever grateful for family ❤️'},
        {'path': 'assets/Ashish/Ashish9.jpg', 'caption': 'Chasing dreams with passion 🌟'},
      ],
      'Swati': [
        {'path': 'assets/Swati/Swati1.jpg', 'caption': 'The light of our lives 🌟'},
        {'path': 'assets/Swati/swati10.jpg', 'caption': 'A smile that brightens the day 😊'},
        {'path': 'assets/Swati/swati11.jpg', 'caption': 'Spreading joy everywhere 🌸'},
      ...
      'Family ❤️': [
        ...
        {'path': 'assets/Family/family3.jpg', 'caption': 'Smiles that brighten every moment 😊'},
        ...
        {'path': 'assets/Family/family5.jpg', 'caption': 'A family full of love ❤️'},
        {'path': 'assets/Family/family6.jpg', 'caption': 'Forever grateful for family 🙏'},
        {'path': 'assets/Family/family7.jpg', 'caption': 'The strength of togetherness 💪'},
        {'path': 'assets/Family/family8.jpg', 'caption': 'In every hug, a thousand words 🤗'},
        {'path': 'assets/Family/family9.jpg', 'caption': 'Where love begins and never ends ❤️‍🔥'},
      ],
    },
  );
}